...
function GetLocalUserByAccountId(userId) {
...
function GetLocalUserByLocalName(userName) {
    const config = require('../config.json');
...
function GetLocalUserByLocalId(userLocalId) {
    const config = require('../config.json');
...
function GetUserAccountIdByLocalName(userName) {
    const config = require('../config.json');
...
function GetUserAccountIdByLocalId(userLocalId) {
    const config = require('../config.json');
